# Generated by Django 4.2.19 on 2025-02-21 15:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.CharField(blank=True, max_length=14, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_results', to='miuz.applications')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='applications',
            name='type_edu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='miuz.edutype', verbose_name='Talim turi'),
        ),
        migrations.AddField(
            model_name='applications',
            name='user',
